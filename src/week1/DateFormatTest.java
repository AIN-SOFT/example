...
/**
 * DateFormatTest对系统当前时间日期和时间的格式化
 * @author xupeng
 *2019.3.14
 */
public class DateFormatTest {
    public static void main(String[] args) {
        ...
        System.out.println("按照Java默认的日期格式：" + df1.format(date));
        System.out.println("按照指定格式 yyyy-MM-dd hh:mm:ss EE,  系统默认系统区域：" +df2.format(date) );
        System.out.println("按照指定格式 yyyy-MM-dd hh时mm分ss秒 EE, 区域为中国：" +df3.format(date) );
        System.out.println("按照指定格式 yyyy-MM-dd hh时mm分ss秒 EE, 区域为美国：" +df4.format(date) );
